...
class SuperOpsPatchExcel implements FromView, ShouldAutoSize, WithEvents
{
    private $SuperOpsPatch;

    public function __construct(
        $SuperOpsPatch,
    ) {
        $this->SuperOpsPatch = $SuperOpsPatch;
    }

    public function view(): View
    {

        return view('layouts.API.SuperOps.Patch.download_excel', [
            'SuperOpsPatch' => $this->SuperOpsPatch,
        ]);
    }
