...
use App\Mail\Portal\ResetPasswordPortal;
...
class SendingForgotPassword implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::mailer('autoresponder')->to($this->email)->send(new ResetPasswordPortal($this->details, $this->sub));
    }
}
