...
<html>
    ...
    <head>
        ...
        <!-- Custom CSS -->
            ...
            <link rel="stylesheet" href="<?php echo e(asset('/css/custom.css')); ?>" !important>
            <!-- Select2 -->
            <link rel="stylesheet" href="<?php echo e(asset('/css/select2.min.css')); ?>">
            <!-- DHTMLX -->
            <link rel="stylesheet" href="<?php echo e(asset('/css/dhtmlxgantt.css')); ?>">
            <!-- Flatpickr CSS -->
        ...
        <!-- JS -->
            ...
            <!-- DHTMLX -->
            <script src="<?php echo e(asset('/js/dhtmlxgantt.js')); ?>" type="text/javascript"></script>
            <!-- Flatpickr CSS -->
            <script src="<?php echo e(asset('/js/flatpickr.min.js')); ?>" type="text/javascript"></script>
    ...
    <body class="custom-background" uk-height-viewport>
        ...
        <!-- SCRIPT START-->
            ...
            <!-- PAGE PERMISSION INVALID -->
                <?php if(\Session::has('page-permission-invalid')): ?>
                    <script>
                        UIkit.notification({
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                else
                                {
                                    ...
                                    UIkit.notification({
                                        message: '<div class="uk-grid uk-grid-small"><div class="uk-width-auto uk-flex uk-flex-middle"><i class="fa-light fa-circle-check fa-xl fa-nm"></i></div><div class="uk-width-expand"><h4><?php if(' + count + ' > 100): ?> 100+ <?php else: ?> ' + count + ' <?php endif; ?> New Ticket!</h4><span>New ticket has been created.</span></div></div>',
                                        pos: 'bottom-right',
                                        status: 'success',
                                        timeout: 150000,
                                        sticky: true,
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                else
                                {
                                    ...
                                    UIkit.notification({
                                        message: '<div class="uk-grid uk-grid-small"><div class="uk-width-auto uk-flex uk-flex-middle"><i class="fa-light fa-circle-check fa-xl fa-nm"></i></div><div class="uk-width-expand"><h4><?php if(' + count + ' > 100): ?> 100+ <?php else: ?> ' + count + ' <?php endif; ?> New Message!</h4><span>New ticket messages from client.</span></div></div>',
                                        pos: 'bottom-right',
                                        status: 'success',
                                        timeout: 150000,
                                        sticky: true,
            ...
            <!-- CRON PUSH LATEST SOFTWARE -->
                ...
                <?php echo $__env->yieldContent('master.script'); ?>
        <!-- SCRIPT END -->

    </body>

</html>
<?php /**PATH C:\xampp\htdocs\20241115 - dash.covertech.com.my (Alert Only)\resources\views/layouts/master.blade.php ENDPATH**/ ?>