...
<form method="POST" action="{{ route('auth.portal.reset.password.reset.submit') }}">
    @csrf
    <input type="hidden" name="clientID" value="{{ $clientID }}" />
    <div class="uk-margin uk-text-center">
        <h3 class="uk-text-bold">Reset Password</h3>
    </div>
    <div class="uk-margin">
        <span>Please key-in your preferred password to reset.</span>
    </div>
    <div>
